...
function show_calendar() {
	...
	*/
	...
	vWinCal = window.open("", "Calendar", 
		"width=275,height=225,status=no,resizable=no,top=200,left=500");
	}
	vWinCal.opener = self;
	ggWinCal = vWinCal;
...
<table>
<tr>
<TD CLASS="tableheader">Date Range</TD>
		<TD CLASS="tabledata">
			From&nbsp;
			<INPUT TYPE="text" NAME="v_start_date" VALUE="01/08/1998" 
				SIZE="10" CLASS="textbox" onblur="javascript:convert_date(v_start_date);">
			<A HREF="javascript:show_calendar('v_form.v_start_date');">
				<IMG SRC="Images/calendar.gif" WIDTH="20" HEIGHT="18" BORDER="0">
			</A>
			&nbsp;To&nbsp;
			<INPUT TYPE="text" NAME="v_end_date" VALUE="02/09/2002" 
				SIZE="10" CLASS="textbox" onblur="javascript:convert_date(v_end_date)">
			<A HREF="javascript:show_calendar('v_form.v_end_date');">
				<IMG SRC="Images/calendar.gif" WIDTH="20" HEIGHT="18" BORDER="0">
			</A>
		</TD>
</tr>
