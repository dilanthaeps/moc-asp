...
<%	
	...
	'===========================================================================
	'	Template Name	:	MOC Time Charterer  Save Screen
	'	Template Path	:	...0/tc_save.asp
	'	Functionality	:	Save new MOC Time Charterer details or update the existing details
	'	Called By		:	../tc_entry.asp
	...
	if v_no_error <> "" then
'	Response.Redirect "tc_maint.asp?v_message="&v_message
%>
<SCRIPT LANGUAGE="JavaScript">
	self.parent.opener.document.form1.action = "tc_maint.asp?v_message=<% =v_message %>";
...
<%	
	...
	Idval = Request("mode")
	if Idval = "" then
		strSql= "INSERT INTO  moc_time_charterers"
		strSql = strSql & " ( time_charterer_id , SHORT_NAME , FULL_NAME , ADDRESS , TELEPHONE,MOBILE "
		...
		v_message = "MOC Time Charterer details Created Successfully"
	else
		strSql = "UPDATE  moc_time_charterers  A SET "
		...
		strSql = strSql &" where a.time_charterer_id=" & request("time_charterer_id")
		v_message = "MOC Time Charterer details Updated Successfully"
	end if
