...
<%	'===========================================================================
	'	Template Name	:	MOC Inspection Remark  Delete Screen
	'	Template Path	:	.../ins_request_remark_delete.asp
	'	Functionality	:	To MOC Inspection Remark Delete information
	'	Called By		:	../ins_request_remark_maint.asp
	...
	For each i in Request("v_deleteditems")
		strSql="DELETE FROM moc_request_remarks where remark_id="
		strSql=strSql & "'"&i&"'" 
		'Response.Write strSql
		connObj.Execute(strSql)
		v_message = v_message&" MOC Remark Detail <i>: " &i&"</i> deleted Successfully !<br>"
	next      
	...
	v_string="ins_request_remark_maint.asp?v_message="
